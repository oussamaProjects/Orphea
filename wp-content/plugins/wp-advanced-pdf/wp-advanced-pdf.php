...
if (!class_exists('wpppdf')) {
    class wpppdf
    {
        ...
        public function __construct()
        {
            ...
            add_action('wp_footer', array(&$this,    'ptp_hook_div_for_guest'));
         ...
         * @param string $file
         */
        public function ptp_custom_plugin_row_meta($links, $file)
        {
         ...
         */
        public function ptp_custom_bulk_admin_footer()
        {
        }
         ...
         */
        public function ptp_custom_bulk_action()
        {
            global $typenow;
            $post_type = $typenow;
         ...
         */
        public function ptp_custom_bulk_admin_notices()
        {
        ...
        public function ced_admin_notices()
        {
            global $post_type, $pagenow;
            ...
            } elseif ($pagenow == 'post.php' && isset($_SESSION['notmail']) && $_SESSION['notmail'] == 1) {
                ?>
         ...
         */
        public function ptp_generate_pdf_bulk_posts($post_ids)
        {
         ...
         * @param array $post_ids
         */
        public function ptp_generate_pdf_file_bulk($post_ids)
        {
         ...
         * @return array|string
         */
        public function ptp_add_export_to_pdf_option_hier($actions, $post)
        {
         ...
         * @return array|string
         */
        public function ptp_add_export_to_pdf_option_nhier($actions, $post)
        {
            if (isset($this->options['admin_panel'])) {
                if (!isset($this->options[$post->post_type])) {
                    return $actions;
        ...
        public function ptp_init_theme_method()
        {
            add_thickbox();
        }
         ...
         */
        public function ptp_hook_div_for_guest()
        {
         ...
         */
        public function ptp_ptpdf_theme_scripts()
        {
         ...
         */
        public function ptp_enqueue_custom_script()
        {
            global $post;
         ...
         */
        public function ptp_on_admin_Init()
        {
         ...
         * @return int
         */
        public function ptp_on_update_options($option)
        {
            return $option;
        }

        public function ptp_action_links_handler($action_links)
        {
         ...
         */
        public function ptp_add_admin_menu()
        {
         ...
         */
        public function ptp_option_page_handler()
        {
        ...
        public function ptp_deafult_setting()
        {
            $default = array(
                    'post'                     => 1,
                    'page'                     => 1,
         ...
         */
        public function ptp_set_default_on_activate()
        {
         ...
         * @return bool
         */
        public function ptp_generate_post_to_pdf()
        {
            global $post;
         ...
         * @return bool
         */
        public function ptp_email_pdf($postID, $useremailID)
        {
         ...
         * @return bool
         */
        public function output_Post_to_pdf_file($pdffile, $file_name, $mimepdftype = '')
        {
         ...
         * @param string $useremailID
         */
        public function generate_pdf_file_email($postID, $useremailID)
        {
            $post    = get_post($postID);
            $content = $post->post_content;
            if (!class_exists('TCPDF')) {
...
// 			$pdf->AddPage ();
         ...
         * @param int $postID
         */
        public function generate_post_to_pdf_file($postID)
        {
            $logo_width = '';
            $post       = get_post($postID);
            $content    = $post->post_content;
         ...
         * @return string
         */
        public function ptp_add_pdf_link($content)
        {
        ...
        public function ptp_pdf_icon()
        {
            ...
            } elseif (!empty($this->options['custon_link_url'])) {
            ...
            if (isset($this->options['content_position'])) {
                ...
                } elseif ($this->options['content_position'] == 'right') {
                    $style = 'style="float: right;max-width: 50px;"';
                } elseif ($this->options['content_position'] == 'center') {
         ...
         */
        public function ptp_pdfscheduleduration($schedules)
        {
         ...
         */
        public function ptp_cronstarter_activation()
        {
            if (isset($this->options['cache_updation_sch']) && $this->options['cache_updation_sch'] != 'none') {
         ...
         */
        public function ptp_cronstarter_deactivate()
        {
         ...
         */
        public function ptp_update_cache()
        {
            global $wpdb;
         ...
         */
        public function postajax_exportandmail_handle()
        {
         ...
         */
        public function ptp_export_install()
        {
            global $wpdb;
         ...
         */
        public function export_installdata($emailid, $userName = 'guest')
        {
        ...
        public function ptp_add_custom_font()
        {
            if (!current_user_can('manage_options')) {
        ...
        public function ptpdf_email_on_publish($new_status, $old_status, $post)
        {
