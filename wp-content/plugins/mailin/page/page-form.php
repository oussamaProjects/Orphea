									...
									<div class="col-md-6">
										...
										<div id="sib_form_captcha" class="panel panel-default row form-field"
											...
											<div class="row small-content2" style="margin-top: 15px;margin-bottom: 15px;">
												...
												<?php SIB_Page_Home::get_narration_script( __( 'Add Captcha', 'sib_lang' ), __( 'We are using Google invisible reCaptcha for this form. To use Google invisible reCaptcha on this form, you should input site key and secret key.' , 'sib_lang' ) ); ?>
											</div>
