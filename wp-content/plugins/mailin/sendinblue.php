...
if ( ! class_exists( 'SIB_Manager' ) ) {
	...
	class SIB_Manager {
		...
		function install_ma_script() {
            ...
            (function(){window.sib={equeue:[],client_key:"' . $ma_key . '"};var e={get:function(e,n){return window.sib[n]||function(){ var t = {}; t[n] = arguments; window.sib.equeue.push(t);}}};window.sendinblue=new Proxy(window.sib,e);var n=document.createElement("script");n.type="text/javascript",n.id="sendinblue-js",n.async=!0,n.src="https://sibautomation.com/sa.js?key="+window.sib.client_key;var i=document.getElementsByTagName("script")[0];i.parentNode.insertBefore(n,i),window.sendinblue.page()})();
            </script>';
				echo $output;
			}
		}
		...
		function generate_form_box( $frmID = '-1', $lang = '' ) {
			...
			<form id="sib_signup_form_<?php echo esc_attr( $frmID ); ?>" method="post" class="sib_signup_form">
				<div class="sib_loader" style="display:none;"><img
							src="<?php echo esc_url( includes_url() ); ?>/images/spinner.gif"></div>
		...
		static function wpMailNotices() {
			if ( self::$wp_mail_conflict ) {
				echo esc_html( '<div class="error"><p>' . __( 'You cannot to use SendinBlue SMTP now because wp_mail has been declared by another process or plugin. ', 'sib_lang' ) . '</p></div>' );
			}
		}
